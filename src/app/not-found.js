      ...
      <div className="container px-4 py-12 mx-auto">
        ...
        <div className="flex flex-col gap-y-10 md:gap-y-16 justify-center items-center text-center min-h-[60vh]">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/"
              className="flex items-center justify-center gap-2 text-base sm:text-lg bg-green-500 text-white font-medium py-2.5 px-4 rounded-xl hover:bg-green-600 transition-colors"
            >
              <svg
