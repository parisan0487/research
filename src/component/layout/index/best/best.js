    ...
    <div className="relative py-10 w-full md:h-[40rem] h-[31rem] md:mt-40 mt-28 rounded-xl overflow-hidden bg-[url(/assets/img/best.png)] bg-no-repeat">
      <div className="flex flex-wrap justify-center items-center content-center">
        ...
        <div className="flex items-center justify-between w-full mb-6 px-4">
          <Link href="/shop">
            <button className="bg-[#44e4d1] hover:bg-emerald-300 text-white px-4 py-1.5 sm:text-sm md:px-5 md:py-2 text-xs rounded-lg shadow transition">
              مشاهده همه
            </button>
          </Link>

          <h2 className="sm:text-xl font-bold text-gray-800 flex items-center gap-2 whitespace-nowrap flex-shrink-0">
